...
public class NFTDMarketController : MonoBehaviour
{

    public static string NFT_COLLECTION_CONTRACT_ADDRESS = "0xf07f701781ade85a28dB3141B46affcAC8129f7D";
    public static string PACK_CONTRACT_ADDRESS = "0x1265be4D2De662e6299Aa485B91de7b6DD35992F";
    public static string MARKETPLACE_ADDRESS = "0x59A0D321370570108d6468d06eE28948d7dBe70B";
    ...
    private async void ConnectWallet(WalletProvider provider)
    {
        ...
        try
        {
            ...
            {
                provider = provider,
                chainId = 97 // Switch the wallet Goerli on connection
            });
    ...
    {
        // fetch single NFT
        var contract = sdk.GetContract(NFT_COLLECTION_CONTRACT_ADDRESS); // NFT Drop
        count++;
    ...
    public async void MintERC721()
    {
        ...
        // sig mint
        var contract = sdk.GetContract(NFT_COLLECTION_CONTRACT_ADDRESS); // NFT Collection
